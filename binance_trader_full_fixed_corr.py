...
class TradingApp:
    def __init__(self, root):
        ...
        self.info_vars = {
            ...
            "CorrBTC": tk.StringVar(value="N/A"),
        }
    ...
    def create_widgets(self):
        ...
        posf = tk.LabelFrame(bottom, text="Open Positions", padx=5, pady=5)
        posf.pack(fill="both", expand=True)
        self.pos_canvas = tk.Canvas(posf)
        self.pos_frame = tk.Frame(self.pos_canvas)
        vsb2 = tk.Scrollbar(posf, orient="vertical", command=self.pos_canvas.yview)
        self.pos_canvas.configure(yscrollcommand=vsb2.set)
    ...
    def init_client(self):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                self.log(f"Telegram responded with status {resp.status_code}", "error")
    ...
    def search_and_update(self):
        ...
        try:
            ...
            for t in tickers:
                ...
                corr_ok = abs(corr_coef) >= self.filter_corr.get()
                    if (
        ...
        self.log("✅ Поиск завершён.", "success")
